...
export const content: Record<Locale, {
  ...
  it: {
    ...
    creativeTitle: "Creatività",
    aboutCreative:
      "Accanto alla carriera tecnica, coltivo da sempre la passione per la musica, il teatro e la scrittura.",
    musicTitle: "Musica",
    musicDescription: "Dal 4 agosto 2026 è disponibile su tutti i principali store musicali <a href='https://music.imusician.pro/a/vF8qeO25/' target='_blank' rel='noopener noreferrer' class='bio-link'><strong>Before Tomorrow</strong></a>, album musicale frutto di una collaborazione con Gianluca Ferrante, mio caro amico musicista. Visita il <a href='https://www.youtube.com/@Oracles.02' target='_blank' rel='noopener noreferrer' class='bio-link'>canale YouTube ufficiale della band</a>.",
    writingTitle: "Scrittura",
    writingDescription:
      "Il mio primo romanzo si chiama <strong>Ponte numero IX</strong>, una storia che esplora temi di amore, viaggi e seconde opportunità della vita. Il libro è acquistabile su <a href='https://amzn.eu/d/02OQ3CzI' target='_blank' rel='noopener noreferrer' class='bio-link'>Amazon</a> ed è disponibile esclusivamente in copertina rigida.",
  ...
  en: {
    ...
    creativeTitle: "Creativity",
    aboutCreative:
      "Alongside my technical career, I have always cultivated a passion for music, theater, and writing.",
    musicTitle: "Music",
    musicDescription: "Since August 4, 2026, <a href='https://music.imusician.pro/a/vF8qeO25/' target='_blank' rel='noopener noreferrer' class='bio-link'><strong>Before Tomorrow</strong></a> has been available on all major music stores, an album created in collaboration with Gianluca Ferrante, my dear friend and musician. Visit the <a href='https://www.youtube.com/@Oracles.02' target='_blank' rel='noopener noreferrer' class='bio-link'>band’s official YouTube channel</a>.",
    writingTitle: "Writing",
    writingDescription:
      "My first novel is called <strong>Ponte numero IX</strong>, a story exploring themes of love, travel, and second chances in life. The book is available to purchase on <a href='https://amzn.eu/d/02OQ3CzI' target='_blank' rel='noopener noreferrer' class='bio-link'>Amazon</a>, exclusively in hardcover.",
  ...
  es: {
    ...
    creativeTitle: "Creatividad",
    aboutCreative:
      "Junto a mi carrera técnica, siempre he cultivado la pasión por la música, el teatro y la escritura.",
    musicTitle: "Música",
    musicDescription: "Desde el 4 de agosto de 2026, <a href='https://music.imusician.pro/a/vF8qeO25/' target='_blank' rel='noopener noreferrer' class='bio-link'><strong>Before Tomorrow</strong></a> está disponible en las principales tiendas de música, un álbum fruto de una colaboración con Gianluca Ferrante, mi querido amigo músico. Visita el <a href='https://www.youtube.com/@Oracles.02' target='_blank' rel='noopener noreferrer' class='bio-link'>canal oficial de YouTube de la banda</a>.",
    writingTitle: "Escritura",
    writingDescription:
      "Mi primera novela se llama <strong>Ponte numero IX</strong>, una historia que explora temas de amor, viajes y segundas oportunidades en la vida. El libro se puede comprar en <a href='https://amzn.eu/d/02OQ3CzI' target='_blank' rel='noopener noreferrer' class='bio-link'>Amazon</a> y está disponible exclusivamente en tapa dura.",
  ...
  fr: {
    ...
    creativeTitle: "Créativité",
    aboutCreative:
      "Parallèlement à ma carrière technique, je cultive depuis toujours une passion pour la musique, le théâtre et l’écriture.",
    musicTitle: "Musique",
    musicDescription: "Depuis le 4 août 2026, <a href='https://music.imusician.pro/a/vF8qeO25/' target='_blank' rel='noopener noreferrer' class='bio-link'><strong>Before Tomorrow</strong></a> est disponible sur toutes les principales plateformes musicales, un album réalisé en collaboration avec Gianluca Ferrante, mon cher ami musicien. Découvrez la <a href='https://www.youtube.com/@Oracles.02' target='_blank' rel='noopener noreferrer' class='bio-link'>chaîne YouTube officielle du groupe</a>.",
    writingTitle: "Écriture",
    writingDescription:
      "Mon premier roman s’intitule <strong>Ponte numero IX</strong>, une histoire qui explore les thèmes de l’amour, du voyage et des secondes chances dans la vie. Le livre est disponible à l’achat sur <a href='https://amzn.eu/d/02OQ3CzI' target='_blank' rel='noopener noreferrer' class='bio-link'>Amazon</a>, exclusivement en édition reliée.",
  ...
  it: [
    {
      ...
      tags: ["Agile Delivery","Scrum","Project Governance","Process Optimization","Workflow Automation"],
      link: "#",
    },
    {
      ...
      tags: ["Microservices","Cloud-Native","Domain-Driven Design","Event-Driven Architecture","Observability"],
      link: "#",
    },
    {
      title: "AI Enablement",
      ...
      tags: ["AI Strategy","LLM Integration","Conversational Interfaces","DSL Engineering","AI Governance"],
      link: "#",
    },
  ],
  en: [
